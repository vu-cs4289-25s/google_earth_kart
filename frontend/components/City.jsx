...
export default function City({ setLoaded }) {
    ...
    const customBoxes = [
        ...
        //floors
        // For debugging, add "highlight: true" to any mesh to make it red so you can find it in the game.
        { size: [300,1,30], position: [-260+ 364, -32, -30+ 226], rotation: [-2.1, 121.1, 0]}, 
        { size: [20,1,20], position: [-188+ 359, -27.8, 92+ 226], rotation: [0, 100.1, -3.4]}, 
        { size: [90,1,30], position: [-195+ 364, -29, 145+ 226], rotation: [1.5, -96.1, 0]}, 
        { size: [38,1,30], position: [-195+ 365, -27.95, 145+ 200], rotation: [2, -96.1, 0]}, 
        { size: [132,1,30], position: [-121+ 364, -28.5, 183+ 226], rotation: [0, -6.7, 1.2]},
        { size: [23,1,30], position: [-45+ 364, -27, 192+ 226], rotation: [0, -6.7, 0]}, 
        { size: [80,1,30], position: [-50.5+ 364, -26.3, 278+ 190], rotation: [-1.05, -96.1, 0]},  
        { size: [80,1,30], position: [-50.5+ 355, -26, 278+ 265], rotation: [1, -96.1, 0]},
        { size: [80,1,30], position: [-61.5+ 364, -28.5, 390+ 226], rotation: [2.8, -96.1, 0]},
        { size: [80,1,30], position: [-70.5+ 364, -29.7, 462+ 226], rotation: [-1.4, -96.1, 0]},
        { size: [60,1,30], position: [-80.5+ 364, -28, 531+ 226], rotation: [-1.5, -96.1, 0]},
        { size: [175,1,30], position: [-80.5+ 458, -27.5, 531+ 262], rotation: [0, -6.5, 0]}, 
        { size: [175,1,30], position: [-80.5+ 545, -26.5, 531+ 265], rotation: [0, -6.5, 1.2]}, 
        { size: [150,1,30], position: [-80.5+ 695, -21.5, 531+ 280], rotation: [0, -6.5, 2.5]},
        { size: [240,1,30], position: [-80.5+ 798, -21.4, 531+ 125], rotation: [0, -96.1, 1.8]},
        { size: [56,1,30], position: [-80.5+ 780, -18.1, 531+ 275], rotation: [0, -96.1, -0.8]},
        { size: [50,1,30], position: [-80.5+ 787, -18.1, 531+ 226], rotation: [0, -96.1, 1]},
        { size: [250,1,30], position: [-80.5+ 830, -29.5, 531+ -115], rotation: [0, -96.5, 2]}, 
        { size: [150,1,30], position: [-80.5+ 850, -35, 531+ -310], rotation: [0, -96.5, 1]},
        { size: [150,1,30], position: [-80.5+ 870, -37.9, 531+ -458], rotation: [0, -96.5, 1.25]}, 
        { size: [100,1,30], position: [-80.5+ 878, -40.9, 531+ -580], rotation: [0, -96.5, 1.7]}, 
        { size: [100,1,30], position: [-80.5+ 878, -40.9, 531+ -580], rotation: [0, -96.5, 1.7]},
        { size: [50,1,20], position: [-80.5+ 885, -41.9, 531+ -650], rotation: [0, -58, 0]},
        { size: [100,1,30], position: [-80.5+ 870, -41.9, 531+ -650], rotation: [0, -58, 0]},
        { size: [100,1,30], position: [-80.5+ 820, -40.8, 531+ -730], rotation: [0, -58, -1.2]},
        { size: [100,1,30], position: [-80.5+ 768, -41.2, 531+ -816], rotation: [0, -58, 1.7]},
        { size: [100,1,30], position: [-80.5+ 720, -43.5, 531+ -900], rotation: [0, -58, 1]}, 
        { size: [200,1,45], position: [-80.5+ 625, -38.5, 531+ -845], rotation: [0, 30, -3.1]}, 
        { size: [205,1,45], position: [-80.5+ 450, -33.6, 531+ -745], rotation: [0, 30, 0.35]}, 
        { size: [200,1,45], position: [-80.5+ 275, -35.2, 531+ -645], rotation: [0.3, 31, 0.4]},
        { size: [40,1,45], position: [-80.5+ 190, -36.5, 531 + -580], rotation: [0.5, 32, 1.8]}, 
        { size: [200,1,45], position: [-80.5+ 115, -37, 531+ -540], rotation: [0, 30, 0]}, 
        { size: [50,1,30], position: [-80.5+ 95, -36.9, 531+ -480], rotation: [-1, -60, 0]},
    ...
    function Checkpoints() {
        ...
        const [raceResetKey, setRaceResetKey] = useState(0);
 
        useEffect(() => {
            if (!socket) return;
            const handleRaceReset = () => {
                console.log("Race reset detected in Checkpoints, updating key.");
                setRaceResetKey(prev => prev + 1);
            };
            socket.on("race start", handleRaceReset);
            socket.on("reset game", handleRaceReset);
            return () => {
                socket.off("race start", handleRaceReset);
                socket.off("reset game", handleRaceReset);
            };
        }, [socket]);
    ...
    function Checkpoint({ position, rotation, id, socket }) {
              const crossedDuringThisPassRef = useRef(false);
               const DEBOUNCE_DELAY = 150; 
        
               const debouncedEmitCheckpointHit = useMemo(
                   () => debounce(() => {
                       if (!crossedDuringThisPassRef.current) {
                           crossedDuringThisPassRef.current = true;
                           console.log(`DEBOUNCED EMIT: Checkpoint ${id} hit!`);
                           socket?.emit("checkpoint hit", id);
                       }
                   }, DEBOUNCE_DELAY),
                   [socket, id, DEBOUNCE_DELAY]
               );
               ...
               const [ref] = useBox(() => ({
                   ...
                   onCollide: (e) => {
                       if (!crossedDuringThisPassRef.current) {
                           debouncedEmitCheckpointHit();
                       }
                   },
               }), [position, rotation, id, debouncedEmitCheckpointHit]);
        
               useEffect(() => {
                   crossedDuringThisPassRef.current = false;
               }, []); 
